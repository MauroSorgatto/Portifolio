  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Trabalhos</span>
      </h2>
      ...
      <Button href="https://drive.google.com/file/d/1N1LHVLiH9HCPOL1DuCx-OoSwoImrKn7b/view?usp=drive_link" target='blank' variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://www.instagram.com/maurosorgatto/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/MauroSorgatto"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/maurosorgatto/"
